...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JScrollPane topTextScroll = new JScrollPane(this.tTop);
        JScrollPane bottomTextScroll = new JScrollPane(this.tBottom);
        /*
         ...
         * and top to bottom
         */
        this.add(topTextScroll);
        this.add(bottomTextScroll);
